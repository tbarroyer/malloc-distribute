...
namespace api {
    ...
    std::queue<dtype_kv>* DistributedAllocator::send_value = new std::queue<dtype_kv>();
    std::queue<dtype_kv>* DistributedAllocator::send_key =   new std::queue<dtype_kv>();
    std::queue<dtype_kv>* DistributedAllocator::send_alloc_req =  new std::queue<dtype_kv>();
    std::queue<dtype_kv>* DistributedAllocator::send_alloc_resp = new std::queue<dtype_kv>();
